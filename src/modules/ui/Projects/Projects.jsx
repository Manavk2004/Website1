...
function Projects() {
  return (
    <div className='bg-[#1a1823]/97 h-fit w-full grid grid-cols-13 auto-rows p-4'>
      ...
      <ProjectCard title="Nimbus KeyBoards" description="3D E-Commerce Website" class="border-0! col-start-10 col-end-13 row-start-2 row-end-7" image="/nimbus.png" name="Nimbus"/>
    </div>
  )
}
