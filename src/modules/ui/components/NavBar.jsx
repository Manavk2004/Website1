...
function Navigation() {
  return (
    <Navbar expand="lg" className="bg-body-tertiary bg-black! p-3! w-full h-15 sticky! top-0 z-10">
      <Container className=" w-full m-0!">
        <Navbar.Brand href="#home" className="text-white! sticky!">MK</Navbar.Brand>
